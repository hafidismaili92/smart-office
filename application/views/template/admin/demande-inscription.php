    ...
    <body id="skin-color" class="inter">
                ...
                <div class="content container-fluid">
                	...
                	<div class="crms-title row bg-white">
                		<div class="col  p-0">
			                ...
			                </span> Demande d'inscription Par entreprises</h3>
                		</div>
							...
							<div class="card mb-0">
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-striped table-nowrap custom-table mb-0 datatable" id="entreprise-demande-table">
											<thead>
											<th>Numero</th>
								<th></th>
							<th>Nom</th> 
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				table = $('#entreprise-demande-table').DataTable({
					processing: false,
	stateSave: false,
	/*"scrollY":        "70vh",
	"scrollCollapse": true,*/
	ajax: {
		url: base_url+'admin/entreprisesDemandes',
		type: "post",
		datatype: "json",
   ...
   columnDefs : [{targets: [0,1],"visible": false}]
				...
				/*$.ajax({
					...
					success:function(response)
					{
						...
						reorderData = data.map(function(item){
							var obj = {
								'Numero':item.numero,
								...
								'Tèl' : item.tel,
								'Email': item.mail,
								'Demande le' : item.date_demande,
								'Admin': item.administrateur,
								'Activité':item.domaine,
								'Ville':item.ville,
								'action':'<div class="dropdown dropdown-action"><a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a><div class="dropdown-menu dropdown-menu-right" ><a class="dropdown-item demande-detail" href="#">Détails</a><a class="dropdown-item demande-confirm" href="#">Confirmer </a><a class="dropdown-item demande-remove" href="#">Supprimer</a></div></div>'
							};
			...
			$('#entreprise-demande-table').on('click','.dropdown-item',function(e){
				e.preventDefault();

			})
			$('#entreprise-demande-table').on('click','.demande-confirm',function(){
				$('body').loadingModal({
          position:'auto',
          text:'',
          color:'#fff',
...
url : base_url+'admin/confirmDemande',
type: 'post',
data : frmData,
cache:false,
processData:false,
...
success: function(result){
	...
	showInfoBox('success','entreprise confirmée');
