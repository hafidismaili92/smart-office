<!-- Header -->
            <div class="header" id="heading">
				...
				<a id="toggle_btn" href="javascript:void(0);" class="hideRSideBare">
					<span class="bar-icon">
						<span></span>
						<span></span>
						<span></span>
                ...
                <div class="header-left">
                    <a href="index.html" class="logo">
						<img src="<?php echo base_url()?>images/entreprise_logo.png"  alt="Logo" class="sidebar-logo">
						<img src="<?php echo base_url()?>images/entreprise_logo.png"  alt="Logo" class="mini-sidebar-logo">
					</a>
                </div>
				<!-- /Logo -->
				...
				<a id="mobile_btn" class="mobile_btn hideRSideBare" href="#sidebar"><i class="fa fa-bars"></i></a>
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img src="data:<?php echo $profil['photoMime']?>;base64, <?php echo $profil['photo64']?>" alt="">
