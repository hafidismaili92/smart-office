...
<html lang="en">
    <head>
        ...
        <title>Error -wait confirmation</title>
    ...
    <body class="error-page">
        ...
        <div class="main-wrapper text-center">
			...
			<div class="error-box">
			<img src="<?php echo base_url()?>images/waitconfirmation.jpg" alt="SMART-DESK" style="width:300px;">
				<h3><i class="fa fa-clock-o"></i> Compte en cours de validation</h3>
				<p>Votre demande d'inscription est en cours de validation .</p>
				<!-- <a href="index.html" class="btn btn-custom btn-gradient-primary btn-rounded">Back to Home</a> -->
			</div>
