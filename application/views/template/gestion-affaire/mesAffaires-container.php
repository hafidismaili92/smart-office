			...
			<div class="modal right fade" id="add-affaire-modal" tabindex="-1" role="dialog" aria-modal="true">
				<div class="modal-dialog" role="document">
					...
					<div class="modal-content">
						...
						<div class="modal-header">
		                    <h4 class="modal-title text-center">Ajouter un Nouveau Projet</h4>
		                    <button type="button" class="close xs-close" data-dismiss="modal">×</button>
		                  </div>
						...
						<div class="form-group row">
				                        ...
				                        <div class="form-group row">
										 ...
										 <div class="form-group row">
				                        	<div class="col-12">
				                            	<label class="col-form-label">Contrat Concerné</label>
                            					<input class="form-control" type="text" id="numero-contrat" name="numero-contrat">
				                            </div>
				                        </div>
				                         <div class="form-group row">
											<div class="col-sm-12">
					...
					<div class="modal-body">
						...
						<div class="form-row">
							<div class="form-group col-12">
								<label for="edit-affaire-delai">Délai d'exécution (en Jours)</label>
								...
								<small class="form-text text-muted">le Délai d'exécution du Projet en Jours calendaires  </small>
							</div>
						</div>
						<div class="form-row">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <div class="row w-100">
                       <div class="col-md-7 account d-flex">
	                  		...
	                  		<div>
	                  			<p class="mb-0">Projet</p>
	                  			<span class="modal-title num-affaire-text text-info"></span>
                  ...
                  <div class="modal-body project-pipeline">
                    ...
                    <div class="task-infos pt-3">
						<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
							<li class="nav-item"><a class="nav-link active" href="#affaire-details-tab" data-toggle="tab">Détails du Projet</a></li>
              ...
              <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body project-pipeline">
                    ...
                    <div class="task-infos pt-3">
						<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
							<li class="nav-item"><a class="nav-link active" href="#affaire-details-tab" data-toggle="tab">Détails de la Mission</a></li>
									    ...
									    <div class="accordion-body__contents">
										    <table class="table">
				                                <tbody>
				                                    ...
				                                    <tr>
				                                      <td><p  class="detail-mission-item-title">Projet N°:</p></td>
