						...
						<div class="account-wrapper">
							...
							<form id="reset-passwordForm" method="post" action="<?php echo base_url(); ?>Login/resetPassword" >
								...
								<div class="form-group">
									...
									<input id="emp-oldPassword" class="form-control" name="emp-oldPassword" type="password" required>
								...
								<div class="form-group">
									...
									<input id="emp-newPassword" class="form-control" name="emp-newPassword" type="password" required>
								...
								<div class="form-group">
									...
									<input id="emp-confirmPassword" class="form-control" name="emp-confirmPassword" type="password" required>
